...
public class M3U8Utils {
     ...
     *
     * @param urlStr          m3u8 地址
     * @param name            电影名
     * @param parent          目标文件夹
     * @param executorService 任务线程池
     */
    public static void parseM3U8(String urlStr, String name, String parent, ExecutorService executorService) {
        System.out.println("开始解析 m3u8 视频：" + urlStr);
                    ...
                    if (!line.startsWith("#")) {
                        ...
                        if (!line.startsWith("http")) {
                            if (line.startsWith("/")) {
                                ...
                                String contextPath = urlStr.substring(0, urlStr.lastIndexOf("/") + 1);
